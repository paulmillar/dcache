...
public class ByteUnits
{
     ...
     * <p>
     * If {@link #of(ByteUnit)} returns successfully then it is required
     * that {@link #parse(String)} will accept the returned String value and
     * return the origin ByteUnit value.  It is allowed that the parse method
     * returns the same ByteUnit value for different String values.
     */

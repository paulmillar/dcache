 ...
 * of byte sizes; for example, "20 MiB" or "3GB".
 */
public class ByteSizeParser
{
    ...
    public enum NumericalInput
    {
        INTEGER("[-+]?\\d*") {
            @Override
            protected long convert(String givenValue, ByteUnit givenUnits, ByteUnit targetUnits, Coersion coersion) {
        ...
        abstract long convert(String value, ByteUnit givenUnits, ByteUnit targetUnits, Coersion coersion);
    }

    /**
     * How to convert a floating point value to an integer value.
     */
    public enum Coersion
    {
        CEIL {
            @Override
    ...
    public static class Builder
    {
        ...
        private Coersion coersion = Coersion.ROUND;
        ...
        public Builder withCoersion(Coersion coersion)
        {

...
public class AbstractCell extends CellAdapter implements CellMessageReceiver
{
    ...
    private boolean isReplyRequired(CellMessage envelope)
    {
        Object message = envelope.getMessageObject();
        return (message instanceof Message) && ((Message) message).getReplyRequired();
    }
    ...
    public void messageArrived(CellMessage envelope)
    {
        ...
        UOID uoid = envelope.getUOID();
        boolean isReply = isReply(envelope);
        boolean isReplyRequired = isReplyRequired(envelope);
        ...
        if (result != null && !isReply) {
            ...
            if (result instanceof Reply) {
                ...
                if (o instanceof Message) {
                     ...
                     */
                    if (!isReplyRequired) {
                        LOGGER.warn("Reply to {} attempted although message indicates that none is required.",

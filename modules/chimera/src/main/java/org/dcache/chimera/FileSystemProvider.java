...
public interface FileSystemProvider extends Closeable {
     ...
     * <p>
     * May throw FileNotFoundChimeraFsException if the inode does not exist, however since the
     ...
     * <p>
     * May throw FileNotFoundChimeraFsException if such an inode does not exist, however since the
     * mapping is semi persistent (it may only change while Chimera/dCache is shut down), it may be
     * cached and there is no guarantee that the inode exists if this method does not throw an
     * exception.
     * <p>
     ...
     *                                        source
     * @throws DirNotEmptyChimeraFsException  if destination exists, is a directory and not empty
     */

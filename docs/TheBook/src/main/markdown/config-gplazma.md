...
- **oidc** Predicate that matches an OpenID-Connect `sub` ("subject")
   claim.  Example: `oidc:83326983-68a3-4f2c-8f0b-385ecd3e97b2`
   matches users identified by the `sub` claim with the value
   `83326983-68a3-4f2c-8f0b-385ecd3e97b2`.
...
- **entitlement** Predicate that matches an eduPersonEntitlement
   claim.  Example:
   `entitlement:urn:geant:helmholtz.de:group:EXAMPLE#login.helmholtz.de`
